...
const { fetchSubscriptionInvoices } = require("./razorpayservice");
const { generateInvoiceNumber } = require("./InvoiceNumberGenerator");
const {
  getNextSubscriptionInvoiceCount,
} = require("./subscriptionInvoiceCounter");

const syncSubscriptionInvoicesService = async () => {
  ...
  return { saved, skipped, total: invoices.length };
};
